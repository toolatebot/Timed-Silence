...
class BluetoothBroadcastReciever : BroadcastReceiver(){
    ...
    override fun onReceive(context: Context, intent: Intent) {
        Timber.tag(TAG()).e("BluetoothBroadcastReciever: ${intent.action}")

        if (intent.action == BluetoothDevice.ACTION_ACL_CONNECTED) {
            Timber.tag(TAG()).e("BluetoothBroadcastReciever: Device connected!")
        ...
        if (intent.action == BluetoothDevice.ACTION_ACL_DISCONNECTED) {
            ...
            Timber.tag(TAG()).e("BluetoothBroadcastReciever: Device disconnected: $name!")
            ...
            try {
                ...
                Timber.tag(TAG()).e("BluetoothBroadcastReciever: Could not sleep!")
            }
            ...
            if(Trigger(context).checkIfNextAlarmExists()){
                ...
                Timber.tag(TAG())
                    .e("BluetoothBroadcastReciever: No next alarm scheduled, don't update!")
            }
        }
    }
}
